...
class AdcData:
    ...
    cc2_avg_v: float  # CC2 averaged
    internal_vdd_v: float  # Internal VDD voltage
    sample_rate: SampleRate  # Current sample rate
...
def get_sample_rates() -> List[SampleRate]:
    ...
    Returns:
        List of SampleRate objects (2, 10, 50, 1000, 10000 SPS)
    """
    ...
...
def create_packet(packet_type: int, transaction_id: int, data: int) -> bytes:
    ...
    Args:
        ...
        data: Data word - meaning depends on packet_type:
              ...
              - For StartGraph: rate index (RATE_2_SPS, RATE_50_SPS, etc.)
