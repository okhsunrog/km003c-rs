...
pub fn required_wgpu_settings(max_capacity: usize, max_channels: usize) -> WGPUSettings {
    ...
    s.device_required_limits.max_compute_invocations_per_workgroup = 64;
    ...
    s.device_required_limits.max_compute_workgroups_per_dimension = 65535;
    s.device_required_limits.max_immediate_size = size_of::<renderer::PlotParams>() as u32;
    s.device_required_limits.max_storage_buffers_per_shader_stage = 2;
